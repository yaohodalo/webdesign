// api/pledge.js — record a prayer-hour pledge, notify admin, confirm to pledger
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Format the pledge time for emails
      ...
      sendEmail({
        ...
        html: `
          <div style="font-family:Georgia,serif;max-width:600px;color:#25262a;line-height:1.7;">
            ...
            <p>At your appointed time, you join thousands of adorers around the world before the Blessed Sacrament. Find a chapel near you on the map, or spend the hour in silent prayer wherever you are.</p>
